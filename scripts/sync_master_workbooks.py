...
SPECIAL_AI: dict[str, str] = {
    ...
    "MAP0066": "KI: Ich verstehe diesen Parameter als Distanz vom Einlese-Sensor bis zur ersten LED des externen LED-Streifens. Mechanisch gemessen sind aktuell 960.0 mm; der ESP braucht diesen Wegbezug, um den Labelstatus entlang des Streifens korrekt anzuzeigen.",
    ...
    "MAP0075": "KI: Ich verstehe diesen Parameter als minimales Sendeintervall fuer LED-Frames in ms. Der Default 100 ms entspricht 10 Hz und reduziert die Kommunikationslast des LED-Balkens.",
...
LED_CONTROLLER_PARAM_SPECS = [
    ...
    },
    {
        ...
        "format": "NO",
        "message": "Minimales Sendeintervall fuer LED-Frames an den externen Controller (100 ms = 10 Hz Default)",
    },
    {
        "key": "MAP0076",
        "ptype": "MAP",
