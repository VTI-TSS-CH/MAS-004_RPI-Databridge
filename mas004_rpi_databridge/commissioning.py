...
STEP_TEMPLATES: List[CommissioningStepTemplate] = [
    ...
    _step(
        ...
        "moxa",
        "Moxa Modul 3",
        "Direkte Modbus/TCP-Erreichbarkeit bzw. Simulationszustand des dritten Moxa pruefen.",
        kind="auto",
        check_key="moxa3",
        href="/ui/machine-setup/io",
    ),
    _step(
        ...
        "moxa",
        "Moxa Feld-IOs",
        "Langsame Feld-IOs der drei E1213 pruefen: Statusleuchte, Teach-Signale, Motor-DOs und bekannte Maschinenhilfssignale muessen im IO-Bild korrekt erscheinen.",
        kind="manual",
        href="/ui/machine-setup/io",
    ),
    _step(
    ...
    _step(
        ...
        "I0.5, I0.4 und Moxa3 DIO3 pruefen: Label-Anfang/Ende, leichter Debounce, Teach-In und Bandriss-Erkennung muessen sauber funktionieren.",
        kind="manual",
        href="/ui/machine-setup/process",
    ),
    _step(
...
class CommissioningStore:
    ...
    def step_context(self, step_id: str) -> Dict[str, Any]:
        ...
        endpoint_map = {
            ...
            "moxa3": ("moxa3_host", "moxa3_port", "moxa3_simulation"),
