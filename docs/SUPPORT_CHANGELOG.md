...
- Die Stop-Positions-Logikversion wurde auf `5` erhoeht. Die Verifikation zaehlt `moving=true` nicht mehr sofort als Erfolg, sondern pollt bis Ziel erreicht, Stillstand ausserhalb Ziel, Alarm oder Timeout. Damit werden Achsalarme wie bei ID7 nicht mehr durch einen zu fruehen Erfolg verdeckt.
