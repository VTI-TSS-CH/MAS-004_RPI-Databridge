...
- The measuring run expects ESP firmware support for `MOTOR 3 MOVE_REL_MM_OP=...` on the Operation-Data path. Keep `MOVE_REL_MM` reserved for the productive hardware-synchronised takt path.
